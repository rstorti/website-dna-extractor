...
async function verifyDNA(mappedData, screenshotPath, logoPath, youtubeData = null) {
    ...
    try {
        ...
        const prompt = `
            ...
            ${youtubeData ? `
            7. From the YouTube Description provided above, extract any Call To Actions (CTAs) and add them as an array of strings called 'youtube_ctas'.
            8. From the YouTube Description provided above, extract any Social Media URLs and add them as an array of strings called 'youtube_social_links'.
            9. Generate a concise 'youtube_summary' based ONLY on the YouTube description.
